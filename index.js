...
var data = [" ","selamat ulang tahun mitaa....", "semoga panjang umur...", "sehat selalu...", "jangan lupa belajar...", "jangan mudah putus asa..." , "semoga kuliahnya dipermudah", "jangan lupa beliin aku cimoll yaa!!!!!"];
let index = 0; 
...
tidak.addEventListener('click',() => {
    let randomMargin = Math.floor(Math.random() * 100);
    tidak.style.margin = `${randomMargin}px`;
})
